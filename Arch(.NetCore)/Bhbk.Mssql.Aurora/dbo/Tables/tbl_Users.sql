CREATE TABLE [dbo].[tbl_Users] (
    ...
    [RequirePassword]    BIT              CONSTRAINT [DF_tbl_Users_RequirePassword] DEFAULT ((0)) NOT NULL,
    [RequirePublicKey]   BIT              CONSTRAINT [DF_tbl_Users_RequirePublicKey] DEFAULT ((0)) NOT NULL,
