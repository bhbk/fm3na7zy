CREATE TABLE [dbo].[tbl_UserFolder] (
    ...
    CONSTRAINT [FK_tbl_UserFolder_IdentityID] FOREIGN KEY ([IdentityId]) REFERENCES [dbo].[tbl_UserLogin] ([IdentityId]) ON UPDATE CASCADE,
    CONSTRAINT [FK_tbl_UserFolder_ParentID] FOREIGN KEY ([ParentId]) REFERENCES [dbo].[tbl_UserFolder] ([Id])
);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_tbl_UserFolder]
