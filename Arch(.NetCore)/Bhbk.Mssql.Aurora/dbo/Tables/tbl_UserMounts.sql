CREATE TABLE [dbo].[tbl_UserMounts] (
    ...
    CONSTRAINT [PK_tbl_UserMounts] PRIMARY KEY CLUSTERED ([IdentityId] ASC),
    ...
    CONSTRAINT [FK_tbl_UserMounts_IdentityID] FOREIGN KEY ([IdentityId]) REFERENCES [dbo].[tbl_Users] ([IdentityId]) ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_tbl_UserMounts]
    ON [dbo].[tbl_UserMounts]([IdentityId] ASC);
