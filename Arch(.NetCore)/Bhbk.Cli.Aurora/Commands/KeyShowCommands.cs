...
{
    public class KeyShowCommands : ConsoleCommand
    {
        private static IConfiguration _conf;
        private static IUnitOfWork _uow;
        private static tbl_Users _user;

        public KeyShowCommands()
        {
            IsCommand("show-keys", "Show all public/private key pairs");
        ...
        public override int Run(string[] remainingArguments)
        {
            try
            {
                ConsoleHelper.OutUserPublicKeyPairs(_user.tbl_UserPublicKeys);
