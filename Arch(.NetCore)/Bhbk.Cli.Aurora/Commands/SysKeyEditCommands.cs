...
{
    public class SysKeyEditCommands : ConsoleCommand
    {
        ...
        public SysKeyEditCommands()
        {
            ...
            IsCommand("sys-key-edit", "Edit public/private key pair for system");
            ...
            HasOption("e|enabled=", "Is public/private key pair for system enabled", arg =>
            {
                _isEnabled = bool.Parse(arg);
            });

            HasOption("d|deletable=", "Is public/private key pair for system deletable", arg =>
            {
