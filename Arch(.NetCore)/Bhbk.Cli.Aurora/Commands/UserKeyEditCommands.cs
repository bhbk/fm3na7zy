...
{
    public class UserKeyEditCommands : ConsoleCommand
    {
        ...
        public UserKeyEditCommands()
        {
            ...
            IsCommand("user-key-edit", "Edit public/private key pair for user");
            ...
            HasOption("e|enabled=", "Is public/private key pair for user enabled", arg =>
            {
                _isEnabled = bool.Parse(arg);
            });

            HasOption("d|deletable=", "Is public/private key pair for user deletable", arg =>
            {
